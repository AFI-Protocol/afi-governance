...
**Accepted owner decision — accepted by merge of afi-governance PR #17 on 2026-07-14 (merge commit `a9fc673`); acceptance recorded under ARN-GOV D-ARN-2. This decision designates the canonical signal lifecycle, phase separation and ownership, the finality writer, identifier continuity, and the pre-persistence handoff as protocol-development law; it authorizes no implementation, decides no persistence/API/economic/settlement/scoring-law question, and blesses no shipped code — conforming changes remain separately authorized.**
